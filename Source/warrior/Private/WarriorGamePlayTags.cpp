...
{
	/** Input Tags **/ 
	// FGameplayTag InputTag_Move 라는 전역 변수를 정의
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Event_Combo,"Player.Event.Combo");
	...
	UE_DEFINE_GAMEPLAY_TAG(Shared_Event_RemoveTag, "Shared.Event.RemoveTag");
